...
export class ReviewsController {
  ...
  async findByTarget(
    ...
    return await this.reviewsService.findByFilter(filter);
  }
  ...
  async findByClient(@Query('userId') userId: string) {
    return await this.reviewsService.findByFilter({ userId: userId });
  }
  ...
  async findByRating(@Query('rating') rating: string) {
    ...
    return await this.reviewsService.findByFilter({ rating: ratingNum });
  }
